...
Let's stick with the example of house prices. This is possibly the worst example for my case, so it will be interesting to see if it is possible to write about it in a way that responds to what Mol, Whitehead and Wilson propose. 
