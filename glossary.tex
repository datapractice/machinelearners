...
\newglossaryentry{statement}{name={statement}, description={Michel Foucault's term for the operation of an enunciative function that relates a number of elements to a field of objects, establishing subject positions associated with them, and configuring a domain of coordination in which these elements can be invoked, used, and repeated. }}
\newglossaryentry{enunciativefunction}{name={enunciative function}, description={For Michel Foucault, the specific relation of a statement to itself, the relation to a subject, the correlate domain and material existence of a statement.}}
