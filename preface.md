...
- Sophien Strasse, Berlin, June 1994: the inception of a desire? Maybe a certain authorisation, to allow work with signals, algorithms, code etc to encounter writing
