...
Title & Year \\ 
  \hline
A framework for measuring differences in data characteristics & 2002 \\ 
  Computer-mediated knowledge sharing and individual user differences: an exploratory study & 2004 \\ 
  Biclustering Gene Expression Data using MSR Difference Threshold & 2009 \\ 
  Comparative Transcriptomic Approach To Investigate Differences in Wine Yeast Physiology and Metabolism during Fermentation & 2009 \\ 
  Classifier-based analysis of visual inspection: Gender differences in decision-making & 2010 \\ 
  SVM-Based Speaker Recognition Considering Gender Differences & 2010 \\ 
  CHARACTERIZING MORPHOLOGY DIFFERENCES FROM IMAGE DATA USING A MODIFIED FISHER CRITERION & 2011 \\ 
  Living Multiples: How Large-scale Scientific Data-mining Pursues Identity and Differences & 2013 \\ 
  Differential Evolution with Temporal Difference Q-Learning Based Feature Selection for Motor Imagery EEG Data & 2013 \\ 
  Constrained Least-Squares Density-Difference Estimation & 2014 \\ 
   \hline
\end{tabular}
\endgroup
