#,b $N = all$: machine learning gets all the data
...
## Sampling in parameter estimation

[HERE] = the estimation of the parameters -- EM, MCMC, etc -- how is that sampling? Describe how all of this is a kind of involution of the empirical; so that the empirical is not simply what is felt in the world, but a feeling for the world of the machine;
