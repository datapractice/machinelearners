...
The assumption that all of the features are 'statistically independent' effectively means that the model observes the world as a set of incoherent or unrelated processes. In the case of document classification, a standard application of the technique, the intuition is often expressed  in terms of an author who writes documents by first choosing a topic, and then selecting a set of words that relate to that toic. As Alpaydin puts it:
