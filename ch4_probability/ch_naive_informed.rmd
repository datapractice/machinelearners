...
```{r nb_applications, results='asis'}
    ...
    tab = xtable(head(nb2[order(nb2$PY),],30), caption = 'Most cited Naive Bayes publications 1945-2015', align = c("p{0.05\\textwidth}",  "p{0.8\\textwidth}",  "p{0.1\\textwidth}", "p{0.15\\textwidth}"), label='tab:nb_most_cited')
