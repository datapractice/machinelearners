...
This plot of 1000 somewhat random points has no obvious structure, but there are functions generating the points. The dataset here has only four dimensions (`x`, `y`, colour and size).   Every point belongs to a class. That is, it can be classified.  
