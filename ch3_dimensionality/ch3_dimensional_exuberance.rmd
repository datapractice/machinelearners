...
```{r aid, echo=TRUE, cache=TRUE, message=FALSE, warning=FALSE, comment=NA , fig.cap='Early uses of the Automatic Interaction Detector'} 
    library(xtable)
