...
How does this injection of statistical technique change machine learning? From the earlier decision tree techniques of the 1960s  -- the Automatic Interaction Detector and the Concept Learning System - automated repetition of tree construction had been central. In the early 1980s work, this automation was refined and reshaped by a certain amount of formalism -- the introduction of functions such as the Gini diversity index and measures of information entropy [TBA - ref] -- 
TBC -- more on the random selection of features  -- [TBC -- hwat Breiman actually drew on]
